---
articleUrl: https://distbit.xyz/pooled-rare-event-count-markets/
author: distbit
category: blog
date: 2026-09-02 00:00
description: Shared collateral makes rare-event claims depend on how many events occur.
  A count market prices that hidden exposure and supports fixed-divisor or tranched
  coverage.
gist_url: https://gist.github.com/414d6bae9fcdaf62d26aaacdfc93edcf
headerImage: false
hidden: false
layout: post
live: true
published: true
tag: []
title: Pooled rare event count markets
---

...
# The Different Types of Futarchy: More Than You Wanted to Know  
...
1.  **Asset Futarchy:** Creates markets predicting the future value of the project's governance token. These predictions are usually denominated in a quote asset, like a USD stablecoin (e.g., USDC).  
...
Efficiency in Futarchy often relates to capital and liquidity. How much money do traders need to lock up, and how easily can they enter and exit positions?  
...
Introducing leverage via liquidations significantly boosts capital efficiency for *both* Asset and KPI Futarchy.  

This is particularly helpful for pricing the impact of proposals that have a low probability of being approved. Without leverage, a trader might need to deposit $1 in collateral to participate in a conditional market segment notionally worth only 3 cents (representing a 3% chance of the decision being taken). This is highly inefficient. Leverage allows meaningful participation without excessive capital lockup, ensuring potentially valuable information about unlikely-but-impactful ideas isn't lost. Eliciting this information is key to giving fringe ideas a fair hearing.  
...
A trader's profit and loss (PnL) should ideally reflect the accuracy of their prediction about the proposal's impact.  
...
Flexibility refers to how easily Futarchy can be adapted to different goals, sensitivities, and organizational needs. Generally, KPI Futarchy offers more flexibility.  
...
Asset Futarchy is primarily suited for one goal: maximizing the value of the target asset. This makes it ideal for the top-level governance of organizations whose main objective is to increase value for shareholders or token holders.  
...
Robustness relates to resistance against manipulation and distortion, alignment with stakeholder interests, and reliability over time. Generally, Asset Futarchy has superior properties here due to the nature of asset markets.  

#### Proposal Impact-Distortion  
...
#### Manipulation Impact for Organisations  
...
#### Manipulation Impact for Traders  

Traders care about metric manipulation primarily because it creates *adverse selection risk*. A bad actor who knows how to manipulate the final KPI value (or asset price, though often harder) can trade profitably against uninformed participants.  
...
#### Minority-Owner Alignment  

Asset price is a metric that aligns well with the interests of *all* owners, especially minority holders. (Recommended reading: [Futarchy as Trustless Joint Ownership](https://www.umbraresearch.xyz/writings/futarchy)). In traditional DAOs or corporations, minorities are often subject to the whims of majority coalitions, exposing them to potential value extraction (expropriation). Futarchy, by ensuring decisions pass only if they are predicted to increase token value, provides a strong protection against this, potentially more effective than traditional legal recourse.  
